...
base_url = "https://a2f54faa9c79745f795eea54ae09d029-f4695fd2fc8f6c01.elb.us-east-1.amazonaws.com/deployment/sharmistha-choudhury/mistral/v1/"
_htx_cli = (
    httpx.Client(verify=False) if base_url.startswith("https") else None
)

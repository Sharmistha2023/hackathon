...
async def main() -> None:
    ...
    async with httpx.AsyncClient(verify=False) as httpx_client:
        client = A2AClient(httpx_client=httpx_client, url="https://a2f54faa9c79745f795eea54ae09d029-f4695fd2fc8f6c01.elb.us-east-1.amazonaws.com/d3xagent")
        # client = await A2AClient.get_client_from_agent_card_url(
        #     # httpx_client, 'http://localhost:9999'
        #     httpx_client, 'https://a2f54faa9c79745f795eea54ae09d029-f4695fd2fc8f6c01.elb.us-east-1.amazonaws.com/d3xagent'
        # )
